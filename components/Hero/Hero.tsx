...
export default function Hero() {
  ...
  return (
    <section className="bg-[#F7F6F3] pt-[calc(56px+14px)] md:pt-[calc(56px+18px)] pb-0 overflow-hidden">
      <div className="max-w-[1200px] mx-auto px-6 md:px-10 flex flex-col items-center text-center">

        {/* CTAs — Watch This hidden until placed elsewhere */}
        <VideoModal open={videoOpen} onClose={() => setVideoOpen(false)} />

        {/* Headline */}
        <motion.h1
          className="text-[clamp(2rem,5.5vw,4rem)] font-[700] leading-[1.04] tracking-[-0.03em] text-[#191919] max-w-[820px] mb-8"
