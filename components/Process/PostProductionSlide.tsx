 ...
 * ---------------------------------------------------------------------------
 * This is the diagram originally built and refined across PostProductionModal
 * (sound design -> highlight cut -> full episode edit -> five fanned outputs,
 * with the highlight cut node opening its own HighlightCutModal). An earlier
 * refactor folded post-production into the ContentProcessModal carousel and,
 * in doing so, dropped this diagram for a plain-text placeholder. This file
 * restores the original design as an embeddable slide — same geometry, same
 * labels, same highlight-cut interaction — so it can sit inside the carousel
 * instead of its own standalone modal.
 */
