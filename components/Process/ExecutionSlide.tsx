    ...
    <div className="relative w-full">
      ...
      >
        <div className="absolute inset-0">
          ...
          >
            <defs>
              <linearGradient id="executionFlowGradient" x1="0" y1="0" x2="0" y2="1">
            ...
            {EXECUTION_STEPS.slice(0, -1).map((_, i) => {
              const fromId = EXECUTION_STEPS[i].id;
              const toId = EXECUTION_STEPS[i + 1].id;
              return (
                <motion.path
            ...
            {EXECUTION_STEPS.slice(0, -1).map((_, i) => {
              ...
              return (
                <motion.path
                  key={`flow-${i}`}
                  d={trunkPath(TRUNK_Y[fromId], TRUNK_Y[toId])}
                  stroke="url(#executionFlowGradient)"
                  strokeWidth={3}
                  strokeLinecap="round"
